...
namespace Frontend.Web.Services.Agents
{
    public class AgentService
    {
        ...
        public async Task<ApiResponse<IEnumerable<Backend.Domain.Entities.Agents.Agent>>> GetAgents(string tenantId)
        {
        ...
        public async Task<ApiResponse<Backend.Domain.Entities.Agents.Agent>> GetAgent(string tenantId, string agentId)
        {
