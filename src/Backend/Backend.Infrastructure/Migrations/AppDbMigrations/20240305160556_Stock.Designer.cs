...
namespace Backend.Infrastructure.Migrations.AppDbMigrations
{
    ...
    [Migration("20240305160556_Stock")]
    partial class Stock
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Categories.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 3, 5, 16, 5, 56, 653, DateTimeKind.Utc).AddTicks(8211),
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = new Guid("b72f87ed-8854-45a3-be99-c8d7b0d4eac8"),
                            Active = true,
                            CategoryId = new Guid("63cf51c6-e90e-4725-b6c3-1c40986d6847"),
                            ColorName = "Preto",
                            Created = new DateTime(2024, 3, 5, 16, 5, 56, 653, DateTimeKind.Utc).AddTicks(8351),
                        ...
                        new
                        {
                            ProductId = new Guid("297abe6a-e843-4dd6-8fe3-cf3769436b14"),
                            Active = true,
                            ColorName = "Azul-Marinho",
                            Created = new DateTime(2024, 3, 5, 16, 5, 56, 653, DateTimeKind.Utc).AddTicks(8358),
            ...
            modelBuilder.Entity("Backend.Domain.Entities.SubCategories.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            CategoryId = new Guid("63cf51c6-e90e-4725-b6c3-1c40986d6847"),
                            Created = new DateTime(2024, 3, 5, 16, 5, 56, 653, DateTimeKind.Utc).AddTicks(8285),
            ...
            modelBuilder.Entity("Backend.Domain.Entities.Stock.Stock", b =>
                {
                    ...
                    b.HasOne("Backend.Domain.Entities.Products.ProductVariant", "ProductVariant")
                        .WithMany()
